...
import 'package:ready_next/workspaces/presentation/workspaces_settings/general/widgets/workspace_general_tab_view.dart';
...
import 'package:ready_next/workspaces/presentation/workspaces_settings/members/widgets/workspace_members_tab_view.dart';
...
import 'package:ready_next/workspaces/presentation/workspaces_settings/notifications/widgets/workspace_notifications_tab_view.dart';
...
class _WorkspaceSettingsModalState extends State<WorkspaceSettingsModal> {
  late WorkspaceSettingsTab _currentTab;
                      ...
                      child: Column(
                        children: [
                          _SidebarTabButton(
                            ...
                            isSelected:
                                _currentTab == WorkspaceSettingsTab.general,
                            onTap: () => setState(
                              () => _currentTab = WorkspaceSettingsTab.general,
                            ),
                          ),
                          ...
                          _SidebarTabButton(
                            ...
                            isSelected:
                                _currentTab == WorkspaceSettingsTab.members,
                            onTap: () => setState(
                              () => _currentTab = WorkspaceSettingsTab.members,
                            ),
                          ),
