...
class _ProjectCustomStatusEditorDialogState
  ...
  late final ValueNotifier<String> _selectedColorHex;
  late final ValueNotifier<TaskStatusCategory> _selectedCategory;
  ...
  void initState() {
    ...
    _selectedColorHex = ValueNotifier(
      widget.initialStatus?.colorHex ?? _statusColors.first,
    );
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<String>(
      valueListenable: _selectedColorHex,
      builder: (context, selectedColorHex, _) =>
          ValueListenableBuilder<TaskStatusCategory>(
            ...
            builder: (context, selectedCategory, _) =>
                WorkspaceCreationModalWrapper(
                  ...
                  subtitle: 'Skonfiguruj nazwę, kategorię etapu, limit WIP oraz kolor kolumny.',
                  icon: Icons.view_column_rounded,
                  accentColor: _parseHex(selectedColorHex),
                      ...
                      Wrap(
                        ...
                        children: [
                          for (final hex in _statusColors)
                            InkWell(
                              onTap: () => _selectedColorHex.value = hex,
