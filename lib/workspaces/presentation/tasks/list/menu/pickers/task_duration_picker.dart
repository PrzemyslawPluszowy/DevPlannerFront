...
import 'package:devplanner/workspaces/presentation/tasks/list/menu/pickers/task_duration_picker_anchor.dart';
      ...
      builder: (dialogContext) {
        ...
        return ValueListenableBuilder<int>(
          ...
          builder: (context, selectedTotalMinutes, _) {
            ...
            const margin = 12.0;
            final popupOffset = TaskDurationPickerAnchor.resolve(
              anchor: position,
              viewport: screenSize,
