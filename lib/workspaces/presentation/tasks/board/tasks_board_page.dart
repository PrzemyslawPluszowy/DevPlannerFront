...
export 'tasks_project_view.dart' show TasksProjectView;
...
part 'tasks_board_header_layout.dart';
part 'tasks_board_header_actions.dart';
part 'tasks_board_header_create_actions.dart';
part 'tasks_board_header_quick_create_dialog.dart';
part 'tasks_board_header_filters.dart';
