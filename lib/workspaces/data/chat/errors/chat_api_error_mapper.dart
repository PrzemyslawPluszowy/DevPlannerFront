...
final class ChatApiErrorMapper {
  ...
  String _codeValue(ChatApiErrorCode code) => switch (code) {
    ...
    ChatApiErrorCode.loadLinkPolicy => 'chat.link_policy.load_failed',
    ChatApiErrorCode.loadLinkPreview => 'chat.link_preview.load_failed',
    ChatApiErrorCode.prepareSnippet => 'chat.snippets.prepare_failed',
