...
part of 'task_advanced_api.dart';
...
class _TaskAdvancedApi implements TaskAdvancedApi {
  _TaskAdvancedApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<TaskMutationResponse<TaskRecurrenceResponse>> createRecurrence(
    ...
    String projectId,
    String taskId,
    CreateTaskRecurrencePayload body,
  ) async {
    ...
    final _options = _setStreamType<TaskMutationResponse<TaskRecurrenceResponse>>(
    ...
    late TaskMutationResponse<TaskRecurrenceResponse> _value;
    try {
      _value = TaskMutationResponse<TaskRecurrenceResponse>.fromJson(
        _result.data!,
        (json) => TaskRecurrenceResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
  ...
  Future<TaskRecurrenceResponse> getRecurrence(
    ...
    final _options = _setStreamType<TaskRecurrenceResponse>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TaskRecurrenceResponse _value;
    try {
      _value = TaskRecurrenceResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<TaskMutationResponse<TaskRecurrenceResponse>> updateRecurrence(
    ...
    String projectId,
    String taskId,
    UpdateTaskRecurrencePayload body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  Future<TaskMutationResponse<bool>> deleteRecurrence(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<TaskMutationResponse<bool>>(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TaskMutationResponse<bool> _value;
    try {
      _value = TaskMutationResponse<bool>.fromJson(
        _result.data!,
        (json) => json as bool,
      );
    } on Object catch (e, s) {
  ...
  Future<List<ProjectTaskRecurrenceItemResponse>> getProjectRecurrences(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProjectTaskRecurrenceItemResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    late List<ProjectTaskRecurrenceItemResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ProjectTaskRecurrenceItemResponse.fromJson(
  ...
  Future<List<ProjectTaskRecurrenceRunResponse>> getProjectRecurrenceRuns(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ProjectTaskRecurrenceRunResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<ProjectTaskRecurrenceRunResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) => ProjectTaskRecurrenceRunResponse.fromJson(
              i as Map<String, dynamic>,
            ),
          )
          .toList();
  ...
  Future<CursorPageResponse<TaskHistoryEventResponse>> listHistory(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<CursorPageResponse<TaskHistoryEventResponse>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CursorPageResponse<TaskHistoryEventResponse> _value;
    try {
      _value = CursorPageResponse<TaskHistoryEventResponse>.fromJson(
        _result.data!,
        (json) =>
            TaskHistoryEventResponse.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
  ...
  Future<ProjectTaskWorkflowResponse> getWorkflow(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ProjectTaskWorkflowResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/workspaces/${workspaceId}/projects/${projectId}/task-workflow/',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ProjectTaskWorkflowResponse _value;
    try {
      _value = ProjectTaskWorkflowResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  Future<ProjectTaskWorkflowResponse> updateWorkflow(
    String workspaceId,
    String projectId,
    UpdateProjectTaskWorkflowPayload body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
