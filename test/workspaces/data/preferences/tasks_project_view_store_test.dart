...
void main() {
  ...
  test('nie oddaje wyboru widoku innemu kontu na tym samym urządzeniu', () async {
    SharedPreferences.setMockInitialValues(<String, Object>{
      'devplanner.tasks-view.user-1.ws-1.proj-1': 'kanban',
    });
    var userId = 'user-1';
  ...
  test('bez zalogowanego użytkownika nie zapisuje i nie czyta preferencji', () async {
    SharedPreferences.setMockInitialValues(<String, Object>{});
    final store = SharedPreferencesTasksProjectViewStore(
      currentUserId: () => null,
    );
    ...
    await store.load();
    await store.write(workspaceId: 'ws-1', projectId: 'proj-1', view: 'kanban');
